...
from reco_utils.recommender.newsrec.models.layers import FFTLayer

__all__ = ["NRMSFFTModel"]


class NRMSFFTModel(BaseModel):
    """NRMS model(Neural News Recommendation with Multi-Head Self-Attention)
    combined with FFT Attention Layer (modification made by Eric Morales)
    ...
    def _build_userencoder(self, titleencoder):
        ...
        user_present = FFTLayer(seed=self.seed)(click_title_presents)
    ...
    def _build_newsencoder(self, embedding_layer):
        ...
        pred_title = FFTLayer(seed=self.seed)(y)
